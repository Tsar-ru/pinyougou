		...
		<div id="item">
			...
			<div class="product-info">
				<div class="fl preview-wrap">
                    <#--[{"color":"粉色","url":"http://192.168.25.133/group1/M00/00/01/wKgZhVut2bCAKem_AACn1xp5oY8232.jpg"},-->
                    <#--{"color":"蓝色","url":"http://192.168.25.133/group1/M00/00/01/wKgZhVut2cKAZU1DAAC_wAERn2Q608.jpg"},-->
                    <#--{"color":"金色","url":"http://192.168.25.133/group1/M00/00/01/wKgZhVut2cuABdCNAACnGz_9YE0893.jpg"}]-->
...
购热销商品</em>
                    ...
                    <#--[{"text":"包邮方式","value":"顺丰包邮"},{"text":"颜色","value":"五颜六色"}]-->
                    ...
                    <#--specification_items= -->
					<#--[{"attributeValue":["移动4G","联通4G","双卡"],"attributeName":"网络"},-->
							...
							<#list specificationItems as spec>
								<dl>
									...
									<#list spec.attributeValue as value>
										<dd><a href="javascript:;" ng-click="updateSpec('${spec.attributeName}','${value}' )"  class="{{ isSelected( '${spec.attributeName}','${value}' )?'selected':'' }}">${value}</a></dd>
									</#list>
								</dl>
							</#list>
						</div>
